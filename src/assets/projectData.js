...
export const data = [
  {
    ...
    links: [
      {
        name: "See Code",
        href: "https://github.com/Qreamville/E-commerce-Sneakers-Website",
      },
      {
        name: "View Live",
        href: "https://qreamville.github.io/E-commerce-Sneakers-Website/",
      },
    ],
  },
  {
    ...
    image: mathwhiz,
    about:
      "A math quiz that test your multiplication, division, addition and subtraction skills in 30 seconds. It also includes dark/light theme",
  ...
  },
  {
    ...
    links: [
      {
        name: "See Code",
        href: "https://github.com/Qreamville/Currency-Converter",
      },
      {
        name: "View Live",
        href: "https://qreamville.github.io/Currency-Converter/",
      },
    ],
  },
  {
    ...
    image: rock,
    about:
      "Rock Paper Scissors Lizard Spock is an extension of the classic game of chance, Rock Paper Scissors, created by Sam Kass and Karen Bryla. This application also store users score in local storage",
    stack: ["TailwindCss", "ReactJs"],
    links: [
      {
        name: "See Code",
        href: "https://github.com/Qreamville/Rock-Paper-Scissors-Lizard-Spock",
      },
      {
        name: "View Live",
        href: "https://qreamville.github.io/Rock-Paper-Scissors-Lizard-Spock/",
      },
    ],
  },
];
